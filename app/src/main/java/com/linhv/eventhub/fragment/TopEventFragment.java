 ...
 */
public class TopEventFragment extends Fragment implements MenuItemCompat.OnActionExpandListener {
    private static final String TAG = "TopEventFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_top_event, container, false);
        initView(v);
        event();
        return v;
    }
...
//        feedsAdapter.notifyDataSetChanged();
    ...
    private void loadData() {
        flag_loading = true;
        restService.getEventService().getHotEvents(take, skip, new Callback<GetEventsResponseModel>() {
            @Override
